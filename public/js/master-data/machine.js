...
// { data: 'Name', defaultContent: '', title: t('Name') },
{
  ...
  data: 'MAC',
  defaultContent: '',
  title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('MAC IOT')
}, {
  data: 'Stock_Min',
  defaultContent: '',
...
var tablehis = $('.table-his').DataTable((_$$DataTable2 = {
  ...
  processing: true,
  serverSide: true
}, _defineProperty(_$$DataTable2, "searching", false), _defineProperty(_$$DataTable2, "dom", 'rt<"bottom"flp><"clear">'), _defineProperty(_$$DataTable2, "lengthMenu", [10, 20, 30, 40, 50]), _defineProperty(_$$DataTable2, "ajax", {
  url: route_his,
  dataSrc: 'data',
  data: function data(d) {
    delete d.columns;
